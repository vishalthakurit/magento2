...
{
    /**
     * Path to store config where count of instagram posts per page is stored
     *
     * @var string
     */
     ...
     * @return bool|string
     */
    public function resize(\Excellence\Instagram\Model\Instagram $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
