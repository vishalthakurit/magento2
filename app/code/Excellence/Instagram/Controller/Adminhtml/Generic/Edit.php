...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('generic_Id', $id);
        ...
        if ($id) {
            $model->load($id);
            if (!$model->getId()) {
                $this->messageManager->addError(__('This generic slider no longer exists.'));
        ...
        $this->_coreRegistry->register('generic', $model);

        // 5. Build edit form
		/** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(
            $id ? __('Edit Instagram') : __('Generic Slider'),
            $id ? __('Edit Instagram') : __('Generic Slider')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Generic Slider'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('Create generic Slider'));
        return $resultPage;
    }
}
