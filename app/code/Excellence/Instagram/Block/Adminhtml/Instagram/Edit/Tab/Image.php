    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'instagram_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_instagram_edit_tab_image_prepare_form', ['form' => $form]);
